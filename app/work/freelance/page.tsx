  ...
  return (
    <section>
      ...
      <div className="flex flex-col items-center mt-6">
        ...
        <Carousel items={['/adelman-hero.png', '/adelman-reviews.png', '/adelman-services.png', '/adelman-about.png', '/adelman-accessibility.png', '/adelman-hero-mobile.png', '/adelman-area-footer.png', '/adelman-services-mobile.png', '/adelman-about-mobile.png', '/adelman-accessibility-mobile.png']} />
      </div>
    </section>
  )
}
