...
const page = () => {
  return (
    <section>
      ...
      <div className="flex justify-between items-center gap-8 flex-col lg:flex-row mt-12 mb-4 mx-8 xs:mx-0 w-full">
        <Link href={'https://www.sutterhome.com/'} target='_blank' className='flex flex-col items-center justify-center mb-8 hover:opacity-90 hover:scale-90 transition-all ease-linear'>
          ...
          <div className="relative mt-4">
            <Image src='/sh-screenshot-one.png' alt='Sutter Home' width={2000} height={2000} className='h-20 w-20 xs:h-80 xs:w-80 object-cover rounded shadow shadow-licorice' />
            <Image src='/sh-screenshot-two.png' alt='Sutter Home' width={2000} height={2000} className='h-20 w-20 xs:h-80 xs:w-80 object-cover rounded shadow shadow-licorice  absolute top-10 left-10' />
        ...
        <Link href={'https://www.neyersvineyards.com/'} target='_blank' className='flex flex-col items-center justify-center mb-4 hover:opacity-90 hover:scale-95 transition-all ease-linear'>
